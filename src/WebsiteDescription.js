        ...
        <div className="webinfo">
          ...
          <div className="descriptions">
            ...
            <p>
              ...
              because the project dragged too long and I did not have enough
              time to update the section as it needed my own information. The
              website that I display here is not the original version.
            </p>
          </div>
          <div className="codinglanguage">
            <h3>Languages used:</h3>
          ...
          <div className="designmethod">
            <h3>Web design method:</h3>{" "}
            <p>Paper and Pen (Wireframe) and Figma</p>
          </div>
          <div className="sources">
            <h3>Material sources:</h3>
            <p>
              Pinterest for images. XiaoHongShu for colour palette. Information
              on the anime from Tsurune Wiki and Wikipedia.
            </p>
          </div>
            ...
            <ul>
              <li>
                ...
                <p>
                  ...
                  complete them. But I got to say, though the process of
                  designing usig Figma takes a long time, the visuals really
                  help in finish developing the page quickly.
                </p>
              </li>
              <li>
                <h4>Colour matching</h4>
                <p>
                  Like I mentioned above, I only used Figma to design some of
                  the sections. If you refer to the website, you will notice
                  that I used different colour palettes for some different
                  sections in the website. When I changed to different colour
                  palette, it was quite difficult as I had to match the colours
                  again. However, this time, I had a lot of fun as the colours
                  were pretty {"<3"}.
                </p>
              </li>
              <li>
                ...
                <p>
                  ...
                  ones. This is the first time I added a lot of section and
                  coded earnestly. It took me lots of time to finish this
                  project as I had to focus on other tasks on hand as well. I
                  procastinated along the way as well which led to one of the
                  page in the website not being updated.
                </p>
              </li>
            </ul>
          </div>
          <div class="">
            <a
              href="https://github.com/cosylily/tsurune-lily.git"
              className="button"
            >
              Go to GitHub for the code
            </a>
